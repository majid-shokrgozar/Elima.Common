...
public class UnitOfWork : IUnitOfWork
{
    ...
    private readonly IEnumerable<IDatabaseContext> _databaseApis;
    ...
    public UnitOfWork(
        ...
        IEnumerable<IDatabaseContext> databaseApis)
    {
    ...
    public virtual IReadOnlyList<IDatabaseContext> GetAllActiveDatabaseApis()
    {
        return _databaseApis.ToImmutableList();
    }

    public virtual IReadOnlyList<IDatabaseContext> GetAllActiveTransactionApis()
    {
        return _databaseApis.ToImmutableList();
    }
