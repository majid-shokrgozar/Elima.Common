...
public abstract class DatabaseContext<TDbContext> : DbContext, IDatabaseContext, ITransientDependency
    where TDbContext : DbContext
{
    ...
    public ILogger<DatabaseContext<TDbContext>> Logger { get; set; }

    private static readonly MethodInfo ConfigureBasePropertiesMethodInfo
        = typeof(DatabaseContext<TDbContext>)
            .GetMethod(
    ...
    protected DatabaseContext(DbContextOptions<TDbContext> options)
        : base(options)
    {
    }
