...
using Elima.Common.System.Collections.Generic;
...
public static class StringExtensions
{
    ...
    /// </summary>
    public static byte[] GetBytes([JetBrains.Annotations.NotNull] this string str, [JetBrains.Annotations.NotNull] Encoding encoding)
    {
        Check.NotNull(str, nameof(str));
